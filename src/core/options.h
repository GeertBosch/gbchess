...
constexpr int reverseFutilityMaxDepthLeft = 3;   // Maximum depth left for futility pruning
...
constexpr int qsFrontierInMainMaxDepthLeft = 1;  // Allow QsFrontier TT reuse in shallow non-PV nodes
...
constexpr int moveFutilityMarginSlope = 180;     // Margin slope in cp per depth
constexpr int moveFutilityMarginBase = 240;      // Margin base in cp
constexpr bool iid = true;                       // Internal iterative deepening when no TT move
constexpr int iidMinDepthLeft = 4;               // Minimum depth left to trigger IID
...
constexpr int traceSearchMaxPly = 2;             // Maximum ply to print in tree diagnostics
