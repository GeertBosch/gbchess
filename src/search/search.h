...
extern uint64_t ttProbesMain;
extern uint64_t ttHitsMain;
extern uint64_t ttNoCutMain;
extern uint64_t ttMissKeyMain;
extern uint64_t ttMissKeyMainEmpty;
extern uint64_t ttMissKeyMainOccupied;
extern uint64_t ttMissKeyMainOccupiedCurrentGen;
extern uint64_t ttMissKeyMainOccupiedOldGen;
...
extern uint64_t ttMissDepthAt1Main;
extern uint64_t ttMissDepthAt2Main;
extern uint64_t ttMissDepthAt3Main;
extern uint64_t ttMissDepthAt4PlusMain;
...
extern uint64_t mainHashSeenFirst;
extern uint64_t mainHashSeenRepeat;
