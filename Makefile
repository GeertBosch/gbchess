...
nnue-test: $(call calc_objs,OPT,nnue.cpp nnue_stats.cpp nnue_incremental.cpp ${MOVES_SRCS} fen.cpp)
nnue-debug: $(call calc_objs,DBG,nnue.cpp nnue_stats.cpp nnue_incremental.cpp ${MOVES_SRCS} fen.cpp)
...
EVAL_SRCS=eval.cpp hash.cpp fen.cpp nnue.cpp nnue_stats.cpp nnue_incremental.cpp ${MOVES_SRCS}
